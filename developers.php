    ...
    <body>
        ...
        <section>
            ...
            <div style="text-align: center;">
                <h1 class="font-bold text-6xl py-8 text-center justify-center">Developers</h1><br>
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <img src=".\source\img\eduardo.png" alt="Developer 1" style="width: 200px; height: 200px; border-radius: 50%; display: inline-block">
                        <h2>ARCEGA RODRIGUEZ EDUARDO</h2>
                        <p>Software Engineering student at the University of Colima.</p>
                    </div>
                    <div class="col-lg-4">
                        <img src=".\source\img\jaz.png" alt="Developer 2" style="width: 200px; height: 200px; border-radius: 50%; display: inline-block">
                        <h2>DOMINGUEZ MARCOS JAZMIN</h2>
                        <p>Software Engineering student at the University of Colima.</p>
                    </div>
                    <div class="col-lg-4">
                        <img src=".\source\img\gera.png" alt="Developer 3" style="width: 200px; height: 200px; border-radius: 50%; display: inline-block">
                        <h2>GUTIERREZ RUA GERARDO ADONAI</h2>
                        <p>Software Engineering student at the University of Colima.</p>
                    </div>
                    <div class="col-lg-6">
                        <img src=".\source\img\jan.png" alt="Developer 4" style="width: 200px; height: 200px; border-radius: 50%; display: inline-block">
                        <h2>HIDALGO ROSAS JAN CARLO</h2>
                        <p>Software Engineering student at the University of Colima.</p>
                    </div>
                    <div class="col-lg-6">
                        <img src=".\source\img\rafa.png" alt="Developer 5" style="width: 200px; height: 200px; border-radius: 50%; display: inline-block">
